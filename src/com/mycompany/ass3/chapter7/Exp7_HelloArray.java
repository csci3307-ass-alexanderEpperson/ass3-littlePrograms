...
public class Exp7_HelloArray 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("intArray1 print using Arrays.toString: " + Arrays.toString(intArray1));	
		System.out.println("floatArray print using Arrays.toString: " + Arrays.toString(floatArray));	
		System.out.println("someClassArray using Arrays.toString: " + Arrays.toString(someClassArray));
		System.out.println("3rd element of floatArray is:" + floatArray[2]);		
